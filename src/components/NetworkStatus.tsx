  ...
  return (
    <AnimatePresence>
      {!isOnline && (
        ...
        >
          <div className="bg-rose-600 text-white px-6 py-3 rounded-2xl shadow-2xl flex items-center space-x-3 pointer-events-auto border border-rose-500/20 backdrop-blur-md">
            <div className="bg-white/20 p-2 rounded-xl animate-pulse">
              <WifiOff className="w-5 h-5" />
            </div>
            <div>
              <p className="font-bold text-sm md:text-base">Huna Internet!</p>
              <p className="text-xs opacity-90">Tafadhali unganisha data au Wi-Fi ili kuendelea.</p>
            </div>
          </div>
        </motion.div>
      )}
